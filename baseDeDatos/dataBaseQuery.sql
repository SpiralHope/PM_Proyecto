...
create table empleado_contesta_cuestionario(
	id_curso int,
    id_empleado int,
    respuesta_pregunta_1 varchar(10), -- para saber si selecciono a, b, c, d
    respuesta_pregunta_2 varchar(10),
    respuesta_pregunta_3 varchar(10),
    respuesta_pregunta_4 varchar(10),
    respuesta_pregunta_5 varchar(10)
);
...
create table notificacion(
    ...
    visto boolean,
    mensaje varchar(255),
    link_servicio varchar(255),
    icono_notificacion varchar(255)
);

create table restaurar_password(
	email varchar(255),
    token varchar(255),
    created_at timestamp default current_timestamp
);

CREATE TABLE empleado_comenta_curso
(
	id INT PRIMARY KEY AUTO_INCREMENT,
...
DELIMITER //
CREATE PROCEDURE registroInstructor(IN m_name VARCHAR(255), IN m_last_name VARCHAR(255), IN m_descripcion VARCHAR(255),
IN m_img VARCHAR(255), IN id_empresa VARCHAR(255), m_cumple)
BEGIN

	INSERT INTO instructor(name, last_name, descripcion, img, erased, id_empresa)
	VALUES (m_name, m_last_name, m_descripcion, m_img, id_empresa);
